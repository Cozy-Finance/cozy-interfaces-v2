...
interface IUMATrigger is ICState {
  ...
  function queryIdentifier() view external returns (bytes32);
  ...
  function query() view external returns (string memory);
  ...
  function bondAmount() view external returns (uint256);
